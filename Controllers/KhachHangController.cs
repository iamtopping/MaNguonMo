...
namespace MaNguonMo.Controllers
{
    public class KhachHangController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("KhachHangID,TenKhachHang,SDT")] KhachHang khachHang)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("KhachHangID,TenKhachHang,SDT")] KhachHang khachHang)
        {
